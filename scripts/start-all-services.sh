...
echo "      • POST /screen/action/click   - Click element"
echo "      • POST /screen/action/type    - Type text"
echo "      • POST /screen/overlay/highlight - Highlight element"
echo "      • POST /screen/overlay/toast  - Show notification"
echo "      • GET  /service.health        - Health check"
echo ""
echo "📝 Logs:"
