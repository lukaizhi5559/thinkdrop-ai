import { Activity, Zap, Eye, Headphones, Clipboard } from 'lucide-react';

const ControlPanel = ({ isActive, onToggle, systemStatus }: { isActive: boolean; onToggle: () => void; systemStatus: any }) => {
  return (
